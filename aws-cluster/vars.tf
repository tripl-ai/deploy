...
variable "master_instance_type" {
  description = "The type of instance to start as master (e.g. t3.micro)."
  default = "t3.micro"
}

variable "worker_instance_type" {
  description = "The type of instance to start as worker (e.g. t3.micro)."
  default = "t3.micro"
}
...
variable "driver_instance_type" {
  description = "The type of instance to start as driver (e.g. t3.micro)."
  default = "t3.micro"
}
